...
def generate_notes(article,model, tokenizer,token_n_per_iter = 7000, max_length_val=400, min_length_val= 200, length_penalty_val= 2.0, return_tensors="pt", file_name ='recurrent_neural_network', smart_iterator =False, num_articles = 15):
...
if __name__=='__main__':
    ...
    generate_notes(data, model, tokenizer, token_n_per_iter=5000, max_length_val=360, min_length_val=120,
                   length_penalty_val=2.0, return_tensors="pt", file_name=name, smart_iterator= True)
